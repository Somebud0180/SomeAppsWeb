// Homepage animation for the animated icon
document.addEventListener("DOMContentLoaded", function () {
	const icon = document.getElementById("animated-icon");
	if (icon) {
		icon.style.opacity = "0";
		icon.style.transform = "translateY(40px) scale(0.8)";
		setTimeout(() => {
...
document.addEventListener("DOMContentLoaded", function () {
	const phoneImages = document.querySelectorAll(
		".phone-image, .phone-wide-image"
	);
